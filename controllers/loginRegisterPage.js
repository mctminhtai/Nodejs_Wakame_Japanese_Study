...
exports.get_test = async function (req, res, next) {
    ...
    await models.BLOG.create({
        uuid: uuidv4(),
        slug: convert.stringToSlug('Học tiếng Nhật để tìm kiếm cơ hội việc làm, du học, sinh sống tại Nhật'),
        USERId: 1,
        CATEGORYId: 1,
    ...
    await models.BLOG.create({
        uuid: uuidv4(),
        slug: convert.stringToSlug('Cơ hội việc làm, du học, sinh sống tại Nhật'),
        USERId: 1,
        CATEGORYId: 1,
        description: 'Việc học một ngôn ngữ chưa bao giờ là thừa trong thời đại ngày nay khi chỉ biết mỗi tiếng Anh là chưa đủ. Trong môi trường làm việc cạnh tranh như hiện nay, việc học thêm tiếng nhật là cần thiết để tăng cơ hội việc làm',
        title: 'Học tiếng Nhật để tìm kiếm cơ hội việc làm, du học, sinh sống tại Nhật',
    ...
    await models.BLOG.create({
        uuid: uuidv4(),
        slug: convert.stringToSlug('LỰA CHỌN HỌC TIẾNG NHẬT'),
        USERId: 1,
        CATEGORYId: 1,
        description: 'Việc học một ngôn ngữ chưa bao giờ là thừa trong thời đại ngày nay khi chỉ biết mỗi tiếng Anh là chưa đủ. Trong môi trường làm việc cạnh tranh như hiện nay, việc học thêm tiếng nhật là cần thiết để tăng cơ hội việc làm',
        title: 'Học tiếng Nhật để tìm kiếm cơ hội việc làm, du học, sinh sống tại Nhật',
    ...
    await models.BLOG.create({
        uuid: uuidv4(),
        slug: convert.stringToSlug('Việc học một ngôn ngữ chưa bao giờ là thừa'),
        USERId: 1,
        CATEGORYId: 1,
        description: 'Việc học một ngôn ngữ chưa bao giờ là thừa trong thời đại ngày nay khi chỉ biết mỗi tiếng Anh là chưa đủ. Trong môi trường làm việc cạnh tranh như hiện nay, việc học thêm tiếng nhật là cần thiết để tăng cơ hội việc làm',
        title: 'Học tiếng Nhật để tìm kiếm cơ hội việc làm, du học, sinh sống tại Nhật',
    ...
    await models.BLOG.create({
        uuid: uuidv4(),
        slug: convert.stringToSlug('trong thời đại ngày nay khi chỉ biết mỗi tiếng Anh là chưa đủ'),
        USERId: 1,
        CATEGORYId: 1,
        description: 'Việc học một ngôn ngữ chưa bao giờ là thừa trong thời đại ngày nay khi chỉ biết mỗi tiếng Anh là chưa đủ. Trong môi trường làm việc cạnh tranh như hiện nay, việc học thêm tiếng nhật là cần thiết để tăng cơ hội việc làm',
        title: 'Học tiếng Nhật để tìm kiếm cơ hội việc làm, du học, sinh sống tại Nhật',
